...
if (!empty($id_cliente) && is_numeric($id_cliente)):
	...
	$sql = 'SELECT id, nome, email, cpf, data_nascimento, telefone, celular, endereco, indicado, status, foto FROM tab_clientes WHERE id = :id';
			...
			<?php else: ?>
				<form action="action_cliente.php" method="post" id='form-contato' enctype='multipart/form-data'>
				    ...
				    <div class="form-group">
				      ...
				      <input type="text" class="form-control" id="endereco" name="endereco" value="<?=$cliente->endereco?>" placeholder="Infome o Endereço">
				      <span class='msg-erro msg-nome'></span>
				    </div>
				    <div class="form-group">
				      <label for="indicado">Quem indicou</label>
				      <input type="text" class="form-control" id="indicado" name="indicado" value="<?=$cliente->indicado?>" placeholder="Nome de quem indicou?">
				      <span class='msg-erro msg-nome'></span>
				    </div>						
				    <div class="form-group">
